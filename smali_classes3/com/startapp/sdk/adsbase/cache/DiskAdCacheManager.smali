...
.method public static a(Landroid/content/Context;Lcom/startapp/sdk/adsbase/adlisteners/AdEventListener;)V
    ...
    .line 1
    invoke-static {p0, p1, v0, v1}, Lcom/startapp/j;->a(Landroid/content/Context;Lcom/startapp/sdk/adsbase/adlisteners/AdEventListener;Lcom/startapp/sdk/adsbase/Ad;Z)V
...
.method public static a(Landroid/content/Context;Lcom/startapp/sdk/adsbase/cache/DiskAdCacheManager$DiskCachedAd;Lcom/startapp/sdk/adsbase/cache/DiskAdCacheManager$a;Lcom/startapp/sdk/adsbase/adlisteners/AdEventListener;)V
    ...
    .line 10
    invoke-static {p1, v4}, Lcom/startapp/f0;->a(Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-static {p0, v1, v4, v5, v2}, Lcom/startapp/f0;->a(Landroid/content/Context;Ljava/util/List;ILjava/util/Set;Ljava/util/List;)Ljava/lang/Boolean;
    ...
    .line 15
    new-instance v1, Lcom/startapp/e0;

    invoke-direct {v1, p0, v2}, Lcom/startapp/e0;-><init>(Landroid/content/Context;Ljava/util/List;)V

    invoke-virtual {v1}, Lcom/startapp/e0;->a()V
    ...
    .line 23
    iget-object p2, p2, Lcom/startapp/sdk/components/ComponentLocator;->b:Lcom/startapp/y1;
    ...
    .line 24
    new-instance v1, Lcom/startapp/r2;

    invoke-direct {v1, p0, p3, v0}, Lcom/startapp/r2;-><init>(Landroid/content/Context;Lcom/startapp/sdk/adsbase/adlisteners/AdEventListener;Lcom/startapp/sdk/ads/interstitials/InterstitialAd;)V

    invoke-virtual {p2, p1, v1}, Lcom/startapp/ld;->a(Ljava/lang/String;Lcom/startapp/wb$a;)V
    ...
    .line 34
    invoke-static {p0, p1, v4, v1, v3}, Lcom/startapp/f0;->a(Landroid/content/Context;Ljava/util/List;ILjava/util/Set;Z)Ljava/util/List;
    ...
    .line 38
    sget-object p2, Lcom/startapp/z5;->b:Lcom/startapp/z5;
    ...
    invoke-virtual {p2, v1}, Lcom/startapp/z5;->a(Ljava/lang/String;)Lcom/startapp/y5;
    ...
    iput-object v1, p2, Lcom/startapp/y5;->b:Ljava/util/List;

    .line 42
    iput-object v2, p2, Lcom/startapp/y5;->c:Ljava/lang/String;
    ...
    .line 44
    invoke-virtual {p2, v1}, Lcom/startapp/y5;->a(Lcom/startapp/sdk/adsbase/model/AdDetails;)V

    goto :goto_0

    .line 47
    :cond_6
    invoke-static {p0, p3, v0, v3}, Lcom/startapp/j;->b(Landroid/content/Context;Lcom/startapp/sdk/adsbase/adlisteners/AdEventListener;Lcom/startapp/sdk/adsbase/Ad;Z)V
