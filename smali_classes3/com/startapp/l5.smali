...
.method public static a(Ljava/lang/reflect/Field;)Ljava/lang/String;
    ...
    const-class v2, Lcom/startapp/ob;
    ...
    .line 5
    check-cast v0, Lcom/startapp/ob;

    .line 6
    invoke-interface {v0}, Lcom/startapp/ob;->name()Ljava/lang/String;
...
.method public static b(Ljava/lang/reflect/Field;)Z
    ...
    .line 7
    :cond_1
    check-cast p0, Lcom/startapp/ob;

    .line 8
    invoke-interface {p0}, Lcom/startapp/ob;->complex()Z
